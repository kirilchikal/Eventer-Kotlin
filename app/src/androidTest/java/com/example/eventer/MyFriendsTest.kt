...
class MyFriendsTest {
    ...
    fun setUpBeforeTest() {
        ...
        onView(ViewMatchers.withId(R.id.nav_friends)).perform(ViewActions.click())

    }

    @Test
    fun elementsExistTest() {
        waitToAppear(R.id.toolbar_my_friends)
        onView(ViewMatchers.withId(R.id.toolbar_my_friends))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        onView(ViewMatchers.withId(R.id.rv_friends_list)).check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    }
